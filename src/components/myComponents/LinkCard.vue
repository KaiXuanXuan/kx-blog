<template>
  <div
    class="link-card relative cursor-pointer w-full p-4 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-sm -translate-y-5 opacity-0"
...
const highlightKeyword = (text) => {
  ...
  return text.replace(regex, (match) => `<span class="bg-red-100 text-red-600 border border-red-300 rounded-sm px-0.5">${match}</span>`);
};
